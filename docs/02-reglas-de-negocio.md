...
| **RN-17a** | La unicidad de RN-17 se evalúa sobre el radicado **normalizado** —solo sus dígitos—, aunque se conserve y se muestre tal como lo escribió el abogado. | ★ **Sin esto, RN-17 se burla sin querer.** Se comprobó: `41001 31 03 001 2026 09999 00` y `41001310300120260999900` creaban **dos procesos** en el mismo despacho, y los términos del mismo caso quedaban repartidos entre dos expedientes — el abogado registra en uno y consulta el otro. Es una forma silenciosa de perder vigilancia. | **[D-28] [R-02]** |
| **RN-17b** | Si el radicado **no tiene la forma** de uno colombiano (23 dígitos), el sistema **avisa pero no impide** guardarlo. | Comprobar un formato no es interpretar derecho, así que no choca con RN-36 — pero rechazar sí lo sería: hay tutelas y procesos antiguos con otra forma, y quien sabe cuál es el suyo es el abogado. El aviso atrapa el error real, que es el dedo. | **[D-28]** |
